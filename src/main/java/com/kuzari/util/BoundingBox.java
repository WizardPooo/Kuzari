...
public class BoundingBox {
            ...
            for (int z = minZ; z < maxZ; z++) {
                for (int y = minY - 1; y < maxY; y++) {
                    ...
                    if (BlockUtil.isSolid(block)) {
                        BoundingBox blockBox = ReflectionUtil.getBlockBoundingBox(block);
    ...
    public boolean intersectsWithBox(Object other) {
        if (other instanceof BoundingBox) {
            ...
            float otherMinX = (float) ReflectionUtil.getFieldValue(ReflectionUtil.getFieldByName(other.getClass(), "a"), other);
            float otherMinY = (float) ReflectionUtil.getFieldValue(ReflectionUtil.getFieldByName(other.getClass(), "b"), other);
            float otherMinZ = (float) ReflectionUtil.getFieldValue(ReflectionUtil.getFieldByName(other.getClass(), "c"), other);
            float otherMaxX = (float) ReflectionUtil.getFieldValue(ReflectionUtil.getFieldByName(other.getClass(), "d"), other);
            float otherMaxY = (float) ReflectionUtil.getFieldValue(ReflectionUtil.getFieldByName(other.getClass(), "e"), other);
            float otherMaxZ = (float) ReflectionUtil.getFieldValue(ReflectionUtil.getFieldByName(other.getClass(), "f"), other);
