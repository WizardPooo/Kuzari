...
public class PlayerData {
    ...
    public final Class[] checks = new Class[] {
        ...
        com.kuzari.check.impl.aimassist.AimAssistA.class, com.kuzari.check.impl.aimassist.AimAssistC.class,
         com.kuzari.check.impl.fly.FlyA.class,
        com.kuzari.check.impl.badpackets.BadPacketsA.class, com.kuzari.check.impl.badpackets.BadPacketsB.class
    };
    /*
